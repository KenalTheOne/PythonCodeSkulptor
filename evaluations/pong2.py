...
# if is RIGHT, the ball's velocity is upper right, else upper left
def spawn_ball(direction):
    global ball_pos, ball_vel # these are vectors stored as lists
    ball_pos = [300,200]
    ball_vel[0] = random.randrange(2, 3) #update the range to 120,140
    ball_vel[1] = random.randrange(2, 3) #update the range to 60,180
...
def draw(canvas):
    ...
    # update ball
    ball_pos[0] += ball_vel[0] # adding velocity to current position gives new position
