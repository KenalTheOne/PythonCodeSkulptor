...
# Sorry -- definitely some bugs, but at least I have it mostly working and scoring
...
def draw(canvas):
    ...
    # draw paddles
    canvas.draw_polygon([(0, paddle1_pos - HALF_PAD_HEIGHT), (0, paddle1_pos + HALF_PAD_HEIGHT), (PAD_WIDTH - 2, paddle1_pos + HALF_PAD_HEIGHT), (PAD_WIDTH - 2, paddle1_pos - HALF_PAD_HEIGHT)], PAD_WIDTH - 1, "Blue", "Blue")
    ...
    # draw scores
    canvas.draw_text(str(score1),[75, 35], 28, "Blue")
    canvas.draw_text(str(score2),[525, 35], 28, "Green") 
